...
class FieldSolverFFTCUDA : public FieldSolver{
 ...
 private:
  ...
  amrex::Gpu::DeviceVector<cufftDoubleComplex> d_field_fft;
  amrex::Gpu::DeviceVector<cufftDoubleComplex> d_source_fft;
  amrex::Gpu::ManagedVector<double> d_k2_im;
  amrex::Gpu::ManagedVector<double> d_sigmoid;
