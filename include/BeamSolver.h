...
class BeamSolver{
 ...
 private:
  void advance_cpu(double, Beam *, vector<Field *> *, Undulator *);
#ifdef GENESIS_USE_AMREX
  void advance_gpu(double, Beam *, vector<Field *> *, Undulator *);
#endif
...
inline double BeamSolver::getSCField(int islice){ return efield.getSCField(islice); }
